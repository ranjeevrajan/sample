...
class Offi_CustomerAttribute_Block_Adminhtml_Edit_Tab_Main extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('is_unique', 'select', array(
            'name' => 'is_unique',
            'label' => Mage::helper('customerattribute')->__('Show on initial Page'), //orig:Unique Value
            'title' => Mage::helper('customerattribute')->__('Show on initial Page'), //orig:Unique Value
            'values' => $yesno,
        ));
...
*/
		...
		$fieldset->addField('blog_thumbnail', 'image', array(
        ...
        $fieldset->addField('description', 'textarea', array(
            ...
            'name' => 'description',
            'class' => '',
            'value' => $model_data1->getData('description')
        ));
		
		/*$fieldset->addField('metadata_id', 'hidden', array(
            'label' => Mage::helper('customerattribute')->__('Meta Data Id'),              
            'name' => 'metadata_id',
            'class' => '',
            'value' => '',
        ));*/
